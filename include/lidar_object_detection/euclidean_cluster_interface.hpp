...
public:
  ...
  virtual bool cluster(const sensor_msgs::msg::PointCloud2::ConstSharedPtr & input_msg) = 0;
  virtual void preprocess(const pcl::PointCloud<pcl::PointXYZ>::ConstPtr& pointCloud, const pcl::PointCloud<pcl::PointXYZ>::Ptr outputPointCloud) = 0;
